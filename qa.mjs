...
const perLang = (t) => [
  ...
  ["PMO", App.PMO, { t, reg, intake, issues, say: noop, reload: noop, deep: null, clearDeep: noop, tour: "", valMap, regAll: reg }],
  ["Queue", App.Queue, { t, pending: intake.filter((s) => s.Status === "Pending triage"), decided: 0, reg, say: noop, reload: noop }],
